...
<section id="hero">
  <div id="hero-content" class="container">
    <h1>Find the closest seminar to you</h1>
    ...
    <form class="search-form" action="">
      ...
      <input name="title" type="text" id="search-input" autocomplete="off">
    </form>
  </div>
  <div id="hero-ed">
...
<div class="seminars">
  ...
  <div class="seminar">
    ...
    <div class="seminar-date">
      ...
      <span>{{explode(" ",$seminar->begin)[0]}}</span>
    </div>
    <div class="seminar-date">
  ...
  <div class="create-seminar" style="width:100%;">
    <a style="background-color:black;color:white" href="{{url('/feed/create_seminar')}}" class="">Create Seminar </a>
  </div>
</div>
