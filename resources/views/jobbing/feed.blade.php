...
<div class="feed-wrapper">
  ...
  <div class="right-side">
    <div class="section pages">
     ...
     @endforeach
     @else
       <span class="no-items">You have no pages</span>
     @endif
    </div>
    ...
    <div class="section">
      ...
      @endforeach
      @else
        <span class="no-items">You have no groups</span>
      @endif
    </div>
    ...
    <div class="section">
      ...
      @endforeach
      @else
        <span class="no-items">You have no events</span>
      @endif
    </div>
  </div>
</div>
