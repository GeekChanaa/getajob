...
<body>
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm" style="position: sticky;top: 0;z-index: 10;">
              ...
              <a class="navbar-brand" href="{{ url('/') }}">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                      <form class="search-bar" action="" style="position:relative">
                        <input type="text" placeholder="Search for something..">
                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="28.931px" height="28.932px" viewBox="0 0 28.931 28.932" xml:space="preserve" class=""><g><path d="M28.344,25.518l-6.114-6.115c1.486-2.067,2.303-4.537,2.303-7.137c0-3.275-1.275-6.355-3.594-8.672
            ...
            c1.562,1.562,2.422,3.638,2.422,5.845s-0.859,4.283-2.422,5.846c-1.562,1.562-3.636,2.42-5.845,2.42S7.981,19.672,6.422,18.111z"></path></g></svg>
                      </form>
                    </ul>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            <li class="nav-item">
                                <a class="nav-link login" style="color:#fff" href="{{ route('login') }}">{{ __('Login') }}</a>
                            </li>
                        ...
                        <li class="nav-item">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right drpdwn" aria-labelledby="navbarDropdown">
                                  <a class="dropdown-item profile-dropdown" href="{{url('/myprofile')}}">My Profile</a>
